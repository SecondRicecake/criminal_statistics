...
pnorm(120, mean, std, lower.tail=TRUE)- pnorm(80, mean, std, lower.tail=TRUE)
```
...
res1$p.value < 0.05
```
This implies that the difference between the mean of the two dataset can be significant.
